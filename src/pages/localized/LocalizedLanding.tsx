...
const LocalizedLanding = ({ locale, page }: Props) => {
  const t = getTranslations(locale).landing[page];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO title={t.seoTitle} description={t.seoDescription} keywords={t.seoKeywords} url={lp(pathMap[page])} type="article" noIndex />
