-- Fix: Add authorization check to redeem_access_code to prevent users from redeeming codes for other users
...
DECLARE
  ...
  user_profile RECORD;
BEGIN
  -- SECURITY: Verify caller is redeeming for themselves
